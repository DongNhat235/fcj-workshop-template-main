...
{{< img "images/5-Workshop/5.4-Backend-deployment/create-iam-roles1.png" "Create ECS IAM roles - step 1" >}}

{{< img "images/5-Workshop/5.4-Backend-deployment/create-iam-roles2.png" "Create ECS IAM roles - step 2" >}}
