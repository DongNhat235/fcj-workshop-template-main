...
{{< img "images/5-Workshop/5.4-Backend-deployment/create-alb1.png" "Create the Application Load Balancer - step 1" >}}
...
{{< img "images/5-Workshop/5.4-Backend-deployment/create-alb2.png" "Create the Target Group - step 2" >}}
