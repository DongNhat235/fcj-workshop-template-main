...
{{< img "images/5-Workshop/5.3-Network-infrastructure/configure-routing1.png" "Routing configuration - step 1" >}}

{{< img "images/5-Workshop/5.3-Network-infrastructure/configure-routing2.png" "Routing configuration - step 2" >}}

{{< img "images/5-Workshop/5.3-Network-infrastructure/configure-routing3.png" "Routing configuration - step 3" >}}
