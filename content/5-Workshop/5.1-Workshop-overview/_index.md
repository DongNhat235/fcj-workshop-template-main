...
|---:|---|---|---|
| 1 | `bravelsport-homepage.png` | BravelSport homepage accessed through the project domain | After the project introduction |
| 2 | `deployment-flow.png` | GitHub → EC2 Build Machine → ECR → ECS Fargate flow | After the EC2 Build Machine role section |
