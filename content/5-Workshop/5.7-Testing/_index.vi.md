...
{{< img "images/5-Workshop/5.7-Testing/end-to-end-browser-test.jpg" "Kiểm thử end-to-end trên trình duyệt" >}}
...
{{< img "images/5-Workshop/5.7-Testing/cloudwatch-test-logs.jpg" "CloudWatch Logs trong quá trình kiểm thử" >}}
...
- Phần tiếp theo: [5.8. Bảo mật và chi phí](../5.8-Security-and-cost/)